...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => SearchBloc(), // Consider providing this from a higher level if needed elsewhere
        child: Padding(
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  maxLength: 17, // Using CosChallenge.vinLength would be better if accessible here
                  validator: (value) {
                  ...
                  child: BlocBuilder<SearchBloc, SearchState>(
                    builder: (context, state) {
                      if (state is SearchInitial) {
                        return const Center(child: Text('Please enter a VIN to search.'));
                      }
                      ...
                      if (state is SearchSuccessMultipleItems) {
                        return _buildSuccessMultipleItems(state.auctionDataChoices);
                      }
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Auction Data Found:', style: Theme.of(context).textTheme.titleLarge),
  ...
  Widget _buildSuccessMultipleItems(List<AuctionDataChoice> choices) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Multiple Choices Found:', style: Theme.of(context).textTheme.titleLarge),
        const SizedBox(height: 8),
        Expanded(
